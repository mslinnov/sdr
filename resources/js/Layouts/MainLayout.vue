<template>
    ...
    <div class="relative min-h-screen md:flex font-sans text-gray-900 bg-gray-50">

        <!-- Mobile menu bar -->
        <div class="py-2 px-4 bg-white flex justify-between md:hidden">
            <!-- Logo -->
            ...
            <!-- Nav -->
            <button class="focus:bg-slate-100 p-4 rounded" @click="displaySideBar">
        ...
        <aside class="sidebar absolute md:relative inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition duration-200 ease-in-out
         bg-white py-6 px-10 w-64 border-r border-gray-200 min-h-screen ">
            <!-- Logo -->
            <Link :href="route('dashboard')">
            ...
            <nav>
                ...
                <div class="my-6 text-sm font-medium text-gray-800 w-full border-t border-gray-100"></div>
                <ul>

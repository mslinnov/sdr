    ...
    <div class="h-12 max-w-screen-xl px-8 m-auto flex gap-4 items-center justify-center">
        <ul class="flex flex-wrap -mb-px">
            <li class="mr-2 flex gap-2">
                <span :class="formInjury.bodyFront ? 'app-active-tab' : 'app-inactive-tab'" @click="showFront">Blessures de face </span>
                <span :class="formInjury.bodyFront ? 'app-inactive-tab' : 'app-active-tab'" @click="showBack">Blessures de dos </span>
            </li>
        </ul>
    </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="177.933" height="475.747" viewBox="0 0 177.933 475.747">
                <g id="group_body_front" data-name="Body Front" transform="translate(20.027 7.387)">
                    <g id="Avant_Gauche" data-name="Avant Gauche" transform="translate(-19.548 -6.319)">
                        ...
                        <path @click="showInjuryBox('Psoas_Gauche')" id="Psoas_Gauche" data-name="Psoas Gauche" d="M9756.049,5949.989c-1.988,1.2-2.442,12.75-1.235,15.265s9.126,8.728,10.486,11.137,5.851,22.483,8.4,23.494,16.806,1.617,17.656,0,1.815-33.868,0-35.83S9758.033,5948.789,9756.049,5949.989Z" transform="translate(-9705.597 -5736.396)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Aine_Gauche')" id="Aine_Gauche" data-name="Aine Gauche" d="M9746.783,6000.645c-2.517,1.521-1.448,9.272-2.159,17.878s-.345,11.625,2.159,12.176,16.637,1.215,16.637,0-4.595-18.739-6.227-20.978S9749.3,5999.123,9746.783,6000.645Z" transform="translate(-9699.584 -5767.263)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Avant_Adducteur_Gauche')" id="Avant_Adducteur_Gauche" data-name="Avant Adducteur Gauche" d="M9807.409,6087.522c-1.382,1.282,4.677,10.877,5.687,14.439s4.457,15.409,5.385,16.978.985,4.368,2.021,4.271,1.688-6.2,1.688-8.96.666-13.7,1.185-16.841,1.134-9.311-1.185-9.887S9808.791,6086.24,9807.409,6087.522Z" transform="translate(-9737.995 -5819.985)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Quadriceps_Gauche')" id="Quadriceps_Gauche" data-name="Quadriceps Gauche" d="M9741.264,6085.441c-1.623,2.115-2.2,23.861-1.838,29.267s.65,22.249,1.838,27.389-.334,19.367,1.041,21.657,2.252,4.193,5.1,4.193,21.912.335,24.49,0,1.811-9.936,2.52-15.115,4.3-20.214,2.8-24.135-6.623-20.319-8.182-23.165-4.391-18.118-7.014-19.008S9742.885,6083.326,9741.264,6085.441Z" transform="translate(-9696.543 -5818.625)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Avant_Genou_Gauche')" id="Avant_Genou_Gauche" data-name="Avant Genou Gauche" d="M9742.37,6309.725c-1.806.838-.229,10.692-1.14,13.335s-3.038,7.929-2.251,9.613,25.721.109,27.194,0,.137-4.488,1.666-8.566,4.035-9,4.035-11.746.039-2.307-3.117-2.636S9744.177,6308.888,9742.37,6309.725Z" transform="translate(-9696.229 -5955.832)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Avant_Mollet_Gauche')" id="Avant_Mollet_Gauche" data-name="Avant Mollet Gauche" d="M9738,6378.844c-1.1.952-1.152,16.674,0,24.389s6.257,19.455,7.977,28.115,3.684,18.5,3.845,20.731,13.845,3.03,14.821,1.534-.407-22.006,0-25.241,1.9-12.6,1.9-18.171.2-30.522-1.9-31.008S9739.1,6377.892,9738,6378.844Z" transform="translate(-9695.221 -5998.046)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Cheville_Gauche')" id="Cheville_Gauche" data-name="Cheville Gauche" d="M9767.338,6577.364c-1.271.562-.145,3.2-.514,4.776s-2.789,2.53-2.51,3.6,2.537,1.66,6.379,1.653,11.547.354,12.15-.9.719-8.179-.342-8.817S9768.607,6576.8,9767.338,6577.364Z" transform="translate(-9711.789 -6119.347)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                        <path @click="showInjuryBox('Pied_Gauche')" id="Pied_Gauche" data-name="Pied Gauche" d="M9751.676,6605.985c-1.243.961-6.653,2.874-6.568,3.88s2.754,1.017,6.568.989,20.411.193,21.727,0,1.452-1.117.287-2.512-.764-2.248-2.179-2.357S9752.92,6605.024,9751.676,6605.985Z" transform="translate(-9700.074 -6136.741)" fill="#c4c4c4" stroke="#141313" stroke-width="1"/>
                    </g>
        ...
        <div v-show="formInjury.showForm" class="inset-0 fixed">
            <div class="bg-white bg-opacity-90 rounded-xl p-6 fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
                <form id="injuryform">
                    ...
                    <div class="text-gray-500 text-center font-medium text-sm">Intensité de la douleur :</div>

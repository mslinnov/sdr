    ...
    <div>
        <div class="flex items-center flex-row justify-center">
            <div v-for="overall_condition_type in overall_condition_type_values"
                ...
                <div class="text-gray-600 dark:text-gray-100 text-2xl font-bold pb-4">
                    {{overall_condition_type.value}} %
                </div>
                <div class=" h-64 flex flex-col flex-nowrap justify-end w-16 bg-gray-200 dark:bg-gray-300 rounded-md overflow-hidden">
